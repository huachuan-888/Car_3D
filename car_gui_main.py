...
class CarGuiWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.imu_label = QLabel(f"IMU 滚转: 0.00 | 俯仰: 0.00")
        ...
        # 4. SLAM建图功能按钮
        slam_group = QGroupBox("3D Cartographer 建图操作")
    ...
    def refresh_all_data(self):
        # 更新坐标IMU显示
        self.pos_label.setText(f"坐标 X: {self.ros_node.odom_x:.2f} m | Y: {self.ros_node.odom_y:.2f} m")
